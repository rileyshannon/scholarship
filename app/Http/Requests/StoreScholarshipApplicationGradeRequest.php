...
class StoreScholarshipApplicationGradeRequest extends FormRequest
{
    ...
    {
        return [
            'short_term_goal_grade' => ['required', 'integer', 'min:0', 'max:2'],
            'short_term_goal_comments' => ['nullable', 'string', 'max:1000'],
            'long_term_goal_grade' => ['required', 'integer', 'min:0', 'max:1'],
            'long_term_goal_comments' => ['nullable', 'string', 'max:1000'],
            'received_awards_grade' => ['required', 'integer', 'min:0', 'max:5'],
            'received_awards_comments' => ['nullable', 'string', 'max:1000'],
            'academics_grade' => ['required', 'integer', 'min:0', 'max:4'],
            'academics_comments' => ['nullable', 'string', 'max:1000'],
            'other_organizations_grade' => ['required', 'integer', 'min:0', 'max:5'],
            'other_organizations_comments' => ['nullable', 'string', 'max:1000'],
            'volunteer_events_grade' => ['required', 'integer', 'min:0', 'max:10'],
            'volunteer_events_comments' => ['nullable', 'string', 'max:1000'],
            'career_progression_grade' => ['required', 'integer', 'min:0', 'max:10'],
